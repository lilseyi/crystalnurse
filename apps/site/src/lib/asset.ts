...
// Use this helper for every reference to a file under /public so the
// site works both at the root (custom domain) and under a project-pages
// subpath like /crystalnurse/.
